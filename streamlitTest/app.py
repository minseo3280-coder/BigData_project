...
def load_results():
    """분석 결과 파일 로드"""
    try:
        model_comparison = pd.read_csv('01_model_comparison_results.csv')
        feature_importance = pd.read_csv('02_feature_importance.csv')
        logistic_coef = pd.read_csv('03_logistic_coefficients.csv')
...
def load_images():
    ...
    images = {}
    image_files = {
        'confusion_matrix': '01_confusion_matrix.png',
        'roc_curve': '02_roc_curve.png',
        'feature_importance': '03_feature_importance.png',
        'a11_distribution': '04_a11_distribution.png'
    }
...
if models is None:
    ...
    st.error("""
    다음 파일들이 필요합니다:
    1. random_forest_best_model.pkl
